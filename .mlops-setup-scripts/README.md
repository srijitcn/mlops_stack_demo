...
* Configure a Databricks CLI profile for your staging workspace by running
  ``databricks configure --token --profile "mlops_stack_demo-staging" --host https://adb-8590162618558854.14.azuredatabricks.net``, 
...
* Configure a Databricks CLI for your prod workspace by running ``databricks configure --token --profile "mlops_stack_demo-prod" --host https://adb-8590162618558854.14.azuredatabricks.net``
